...
I am a Software Developer with over 2+ years expertise in designing enterprise softwares and web applications. I have extensive knowledge in HTML5, CSS3, Bootstrap, Sass, Material-UI, Tailwindcss, Javascript, React.js, Redux, Node.js, Express.js, MongoDb, PostgreSQL, Python, Trello, Jira, Jest, Mocha, Responsive Web Design, Next.js and Django. As a Software Developer, I aspire to help bring creative projects to life and demonstrate my commitment to developing world-class software solutions for your company.
